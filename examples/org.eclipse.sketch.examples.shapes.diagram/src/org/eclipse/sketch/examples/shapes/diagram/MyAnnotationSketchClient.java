 ...
 *
 */
public class MyAnnotationSketchClient implements ISketchListener{
	...
	private File createTempElementImage(Sketch s){		
		...
		try {
			...
			generator.setColor(new Color(0,0,200));
	...
	private void setMeta(Unknown unknown_element, Sketch s){
		...
		unknown_element.eSet(ShapesPackage.UNKNOWN__ELEMENT,"Annotation");
