...
public class DiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = ShapesDiagramUpdater
				.getDiagram_1000SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
			result.add(((ShapesNodeDescriptor) it.next()).getModelElement());
		}
		return result;
	}
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(ShapesPackage.eINSTANCE
					.getDiagram_Shapes());
		}
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
					.hasNext();) {
				ShapesLinkDescriptor nextLinkDescriptor = (ShapesLinkDescriptor) linkDescriptorsIterator
						.next();
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final ShapesLinkDescriptor nextLinkDescriptor = (ShapesLinkDescriptor) linkDescriptorsIterator
					.next();
