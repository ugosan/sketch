 ...
 * @generated
 */
public class ShapesBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected ShapesBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		request.setParameter(ShapesBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(ShapesBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(ShapesBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = ShapesElementTypes
