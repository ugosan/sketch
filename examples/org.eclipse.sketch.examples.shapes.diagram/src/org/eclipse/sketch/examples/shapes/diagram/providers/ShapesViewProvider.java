 ...
 * @generated
 */
public class ShapesViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ShapesVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = ShapesVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ShapesElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != ShapesVisualIDRegistry.getNodeVisualID(
								op.getContainerView(), domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!DiagramEditPart.MODEL_ID.equals(ShapesVisualIDRegistry
				...
				case UnknownEditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != ShapesVisualIDRegistry
		...
		return SquareEditPart.VISUAL_ID == visualID
				|| TriangleEditPart.VISUAL_ID == visualID
				|| UnknownEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ShapesVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ShapesVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = ShapesVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = ShapesVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case SquareEditPart.VISUAL_ID:
			return createSquare_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case TriangleEditPart.VISUAL_ID:
			return createTriangle_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case UnknownEditPart.VISUAL_ID:
			return createUnknown_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createSquare_2001(EObject domainElement, View containerView,
		...
		node.setType(ShapesVisualIDRegistry.getType(SquareEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createTriangle_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node
				.setType(ShapesVisualIDRegistry
						.getType(TriangleEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createUnknown_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ShapesVisualIDRegistry.getType(UnknownEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5001 = createLabel(node, ShapesVisualIDRegistry
	...
	public Edge createConnection_4001(EObject domainElement,
		...
		edge.setType(ShapesVisualIDRegistry
		...
		Node label6001 = createLabel(edge, ShapesVisualIDRegistry
				.getType(ConnectionLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createDashedConnection_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ShapesVisualIDRegistry
				.getType(DashedConnectionEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6002 = createLabel(edge, ShapesVisualIDRegistry
				.getType(DashedConnectionLabelEditPart.VISUAL_ID));
