...
/**
 * This is the item provider adapter for a {@link org.eclipse.sketch.examples.shapes.Unknown} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnknownItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Shape_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Shape_label_feature", "_UI_Shape_type"),
				 ShapesPackage.Literals.SHAPE__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addMetaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Unknown_meta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Unknown_meta_feature", "_UI_Unknown_type"),
				 ShapesPackage.Literals.UNKNOWN__META,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Unknown_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Unknown_element_feature", "_UI_Unknown_type"),
				 ShapesPackage.Literals.UNKNOWN__ELEMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Unknown)object).getSvg();
