...
public class ShapesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ShapesPackage.UNKNOWN: {
				Unknown unknown = (Unknown)theEObject;
				T result = caseUnknown(unknown);
				if (result == null) result = caseShape(unknown);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShapesPackage.CONNECTION: {
				...
				if (result == null) result = caseAbstractConnection(connection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShapesPackage.DASHED_CONNECTION: {
				DashedConnection dashedConnection = (DashedConnection)theEObject;
				T result = caseDashedConnection(dashedConnection);
				if (result == null) result = caseAbstractConnection(dashedConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShapesPackage.ABSTRACT_CONNECTION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dashed Connection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dashed Connection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDashedConnection(DashedConnection object) {
		return null;
	}
