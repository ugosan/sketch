...
public class SketchSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SketchPackage.SKETCH: {
				Sketch sketch = (Sketch)theEObject;
				T result = caseSketch(sketch);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SketchPackage.SKETCH_DATABASE: {
				SketchDatabase sketchDatabase = (SketchDatabase)theEObject;
				T result = caseSketchDatabase(sketchDatabase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSketchDatabase(SketchDatabase object) {
		return null;
	}
