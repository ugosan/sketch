...
public class SketchAdapterFactory extends AdapterFactoryImpl {
	...
	protected SketchSwitch<Adapter> modelSwitch =
		new SketchSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSketchDatabase(SketchDatabase object) {
				return createSketchDatabaseAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sketch.Sketch <em>Sketch</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sketch.SketchDatabase <em>Database</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSketchDatabaseAdapter() {
		return null;
	}
