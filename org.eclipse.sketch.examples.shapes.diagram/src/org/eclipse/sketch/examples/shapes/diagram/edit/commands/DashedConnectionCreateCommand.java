 ...
 * @generated
 */
public class DashedConnectionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DashedConnectionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Shape) {
			return false;
		}
		if (target != null && false == target instanceof Shape) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		DashedConnection newElement = ShapesFactory.eINSTANCE
				.createDashedConnection();
	 ...
	 * @generated
	 */
	protected void doConfigure(DashedConnection newElement,
