 ...
 * @generated
 */
public class ShapesDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.ShapesDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.ShapesDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					...
					diagramResource
							.save(org.eclipse.sketch.examples.shapes.diagram.part.ShapesDiagramEditorUtil
									.getSaveOptions());
				} catch (IOException e) {
